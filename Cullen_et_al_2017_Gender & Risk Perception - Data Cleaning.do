...
*Notes
*---------
*The following code cleans and prepares the data. The code for the analysis is included in a separate do file.



clear
**set directories
global input "...\Farmer First_Mali_Data_Raw.dta"
global output "..."
...
save "$output\Farmer First_cleaned.dta", replace
...
**new file pathways - Preserves same sex and single-respondent households by adding new variables
save "$output\Farmer First_cleaned_WIDE.dta", replace 
